...
import com.example.Hamburger.service.HamburgerService;
...
public class HamburgerController {
	...
	public String user(String uid, String uname, int price, String email) {
		List<Hamburger> hamburgerList = hamburgerService.getHamburgerList();
		JSONObject jObj = new JSONObject();
